...
function updateTotal(percentage) {
  ...
  document.getElementById("fcost").innerHTML = " Rs " + fcost;
}
...
function updateTotal2(percentage) {
  ...
  document.getElementById("fcost2").innerHTML = " Rs " + fcost2;
}
function updateTotal3(percentage) {
  ...
  document.getElementById("fcost3").innerHTML = " Rs " + fcost3;
}
...
function updateTotal4(percentage) {
  ...
  document.getElementById("fcost4").innerHTML = " Rs " + fcost4;
  document.getElementById("modalcost").innerHTML = " Rs " + fcost4;
