		...
		<div class="col-md-4 mx-auto mt-5">
			...
			<form name="form1" method="post" action="edit.php">
				<div class="form-floating mt-2">
					<input type="text" name="name" value="<?php echo $name;?>" class="form-control" placeholder="Enter Username">
					<label>Name</label>
				</div>
				<div class="form-floating mt-2">
					<input type="text" name="qty" value="<?php echo $qty;?>" class="form-control" placeholder="Enter Username">
					<label>Qty</label>
				</div>
				<div class="form-floating mt-2">
					<input type="text" name="price" value="<?php echo $price;?>" class="form-control" placeholder="Enter Username">
					<label>Price</label>
				</div>
				<div class="btn-group text-center d-flex mt-2">
